...
require('packer').startup(function(use)
  ...
  -- color scheme
  use { 'catppuccin/nvim', as = 'cattpucin' }
  -- Terminal
  use {
...
local servers = { 'tsserver', 'sumneko_lua', 'jdtls' }
...
require('lspconfig').jdtls.setup {
  on_attach = on_attach,
  capabilities = capabilities,
  -- use only .git as root identifier
...
vim.keymap.set('n', '<C-t>', ':exe v:count1 . "ToggleTerm"<CR>')
